...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        String boardingTime = sdf.format(info.boardingTime);
        String departureTime = sdf.format(info.departureTime);
        String arrivalTime = sdf.format(info.arrivalTime);
        ...
        String hoursAndMinutesUntilBoarding = getString(R.string.countDownFormat, hoursUntilBoarding, minutesUntilBoarding);
